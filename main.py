...
async def on_ready():
    ...
    await bot.change_presence(activity=discord.Game(name=".new <message> | GamXGaming.com"))
...
async def help(ctx):
    ...
    if ctx.author.guild_permissions.administrator or valid_user:
        ...
        em = discord.Embed(title="GamXGaming Help", description="", color=0x00a8ff)
...
async def new(ctx, *, args = None):
    ...
    created_em = discord.Embed(title="GamXGaming", description="Your ticket has been created at {}".format(ticket_channel.mention), color=0x00a8ff)
...
async def close(ctx):
    ...
    if ctx.channel.id in data["ticket-channel-ids"]:
        ...
        try:
            ...
            em = discord.Embed(title="GamXGaming", description="Are you sure you want to close this ticket? Reply with `close` if you are sure.", color=0x00a8ff)
            ...
            em = discord.Embed(title="GamXGaming", description="You have run out of time to close this ticket. Please run the command again.", color=0x00a8ff)
            await ctx.send(embed=em)
    ...
    if valid_user or ctx.author.guild_permissions.administrator:
        ...
        if role_id not in data["valid-roles"]:
            ...
            try:
                ...
                em = discord.Embed(title="GamXGaming", description="You have successfully added `{}` to the list of roles with access to tickets.".format(role.name), color=0x00a8ff)
            ...
            em = discord.Embed(title="GamXGaming", description="That role already has access to tickets!", color=0x00a8ff)
            await ctx.send(embed=em)
    
    else:
        em = discord.Embed(title="GamXGaming", description="Sorry, you don't have permission to run that command.", color=0x00a8ff)
        await ctx.send(embed=em)
    ...
    if valid_user or ctx.author.guild_permissions.administrator:
        ...
        try:
            ...
            if role_id in valid_roles:
                ...
                em = discord.Embed(title="GamXGaming", description="You have successfully removed `{}` from the list of roles with access to tickets.".format(role.name), color=0x00a8ff)

                await ctx.send(embed=em)
            
            else:
                
                em = discord.Embed(title="GamXGaming", description="That role already doesn't have access to tickets!", color=0x00a8ff)
                await ctx.send(embed=em)
    ...
    if valid_user or ctx.author.guild_permissions.administrator:
        ...
        if role_id not in data["pinged-roles"]:
            ...
            try:
                ...
                em = discord.Embed(title="GamXGaming", description="You have successfully added `{}` to the list of roles that get pinged when new tickets are created!".format(role.name), color=0x00a8ff)
            ...
            em = discord.Embed(title="GamXGaming", description="That role already receives pings when tickets are created.", color=0x00a8ff)
            await ctx.send(embed=em)
    ...
    if valid_user or ctx.author.guild_permissions.administrator:
        ...
        try:
            ...
            if role_id in pinged_roles:
                ...
                em = discord.Embed(title="GamXGaming", description="You have successfully removed `{}` from the list of roles that get pinged when new tickets are created.".format(role.name), color=0x00a8ff)
                await ctx.send(embed=em)
            
            else:
                em = discord.Embed(title="GamXGaming", description="That role already isn't getting pinged when new tickets are created!", color=0x00a8ff)
                await ctx.send(embed=em)
...
async def addadminrole(ctx, role_id=None):
    ...
    try:
        ...
        em = discord.Embed(title="GamXGaming", description="You have successfully added `{}` to the list of roles that can run admin-level commands!".format(role.name), color=0x00a8ff)
        await ctx.send(embed=em)
...
async def deladminrole(ctx, role_id=None):
    try:
        ...
        if role_id in admin_roles:
            ...
            em = discord.Embed(title="GamXGaming", description="That role isn't getting pinged when new tickets are created!", color=0x00a8ff)
            await ctx.send(embed=em)
